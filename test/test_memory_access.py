...
request_read_with_seed = [
    ...
    (Feeder.MsgType.CANRX, 0x18D9D4F9, [0x01, 0x13, 0x03, 0x00, 0x00, 0x92, 0x07, 0x00], 0.0),
    (Feeder.MsgType.CANTX, 0x1CD8F9D4, [0x00, 0x11, 0xFF, 0xFF, 0xFF, 0xFF, 0x5A, 0xA5], 0.0),
    (Feeder.MsgType.CANRX, 0x18D9D4F9, [0x01, 0x13, 0x03, 0x00, 0x00, 0x92, 0xA5, 0x5A], 0.0),
    (Feeder.MsgType.CANTX, 0x1CD8F9D4, [0x01, 0x11, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF], 0.0),
    (Feeder.MsgType.CANTX, 0x1CD7F9D4, [0x01, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF], 0.0),
    (Feeder.MsgType.CANTX, 0x1CD8F9D4, [0x00, 0x19, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF], 0.0),
    (Feeder.MsgType.CANRX, 0x18D9D4F9, [0x01, 0x19, 0x03, 0x00, 0x00, 0x92, 0xFF, 0xFF], 0.0),
]
...
#     )
#     ca.send_pgn(0, (j1939.ParameterGroupNumber.PGN.DM14 >> 8) & 0xFF, 0xF9 & 0xFF, 6, [0x01, 0x13, 0x03, 0x00, 0x00, 0x92, 0x07, 0x00])
